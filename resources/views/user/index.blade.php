...
{{-- Category wise product show  end --}}
				...
				<div class="row justify-content-center">
					<div class="col-md-8"style="color:blue;font-size:200%">
						<marquee  direction="left" >
						Welcome to Traning Cholte ,please contact
						...
						<div class="banner-wraps ">
							<div class="m-banner row">
								<div class="banner htmlconten1 col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="banners">
										<div>
											<a href="#"><img src="{{ asset( $slider->mid_slider_1)}}" alt="banner1"></a>
										</div>
									</div>
								</div>
								<div class="htmlconten2 col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="module banners">
											<div>
												<a href="#"><img src="{{ asset( $slider->mid_slider_2)}}" alt="banner1"></a>
											</div>
									</div>
										
									<div class="banners">
										<div>
											<a href="#"><img src="{{ asset( $slider->mid_slider_3)}}" alt="banner1"></a>
										</div>
									</div>
								...
								<div class="banner htmlconten3 hidden-sm col-lg-4 col-md-4 col-sm-6 col-xs-12">
									<div class="banners">
										<div>
											<a href="#"><img src="{{ asset( $slider->mid_slider_4)}}" alt="banner1"></a>
										</div>
									</div>
								</div>
							</div>
